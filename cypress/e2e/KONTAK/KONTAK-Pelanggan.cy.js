...
// describe('[KONTAK-PELANGGAN] - Cari Kontak', () => {
//   const navigateToKontak = () => {
//     cy.get('[data-testid="drawer-item-contacts"]').click();
//   };
...
// describe('[KONTAK-PELANGGAN] - Membuka detail kontak', () => {
//   const navigateToKontak = () => {
//     cy.get('[data-testid="drawer-item-contacts"]').click();
//   };
...
// describe('[KONTAK-PELANGGAN] - Edit Kontak dari detail kontak', () => {
//   const navigateToKontak = () => {
//     cy.get('[data-testid="drawer-item-contacts"]').click();
//   };
...
// describe('[KONTAK-PELANGGAN] - Membuka dan mengecek kesesuaian tampilan modal Pengaturan Grup Kontak', () => {
//   const navigateToKontak = () => {
//     cy.get('[data-testid="drawer-item-contacts"]').click();
//     // cy.url().should('eq', 'https://cashflow.assist.id/admin/contacts');
//   };
...
// describe('[KONTAK-PELANGGAN] - Harus Menampilkan modal grup Kontak', () => {
//   const navigateToKontak = () => {
//     cy.get('[data-testid="drawer-item-contacts"]').click();
//   };
...
// describe('[KONTAK-PELANGGAN] - Mengambil data grup Kontak (datanya ada)', () => {
//   const navigateToKontak = () => {
//     cy.get('[data-testid="drawer-item-contacts"]').click();
//     // cy.url().should('eq', 'https://cashflow.assist.id/admin/contacts');
//   };
...
// describe('[KONTAK-PELANGGAN] - Mengambil data grup Kontak (datanya tidak ada)', () => {
//   const navigateToKontak = () => {
//     cy.get('[data-testid="drawer-item-contacts"]').click();
//   };
...
// describe('[KONTAK-PELANGGAN] - Pengaturan Grup Kontak - Cari Grup', () => {
...
//         console.log('Response Data:', responseData);
//         if(responseData === 0) {
//           cy.get('.MuiPaper-root > .MuiTable-root > .MuiTableBody-root > .MuiTableRow-root > .MuiTableCell-root')
//             .should('be.visible')
...
// describe('[KONTAK-PELANGGAN] - Pengaturan Grup Kontak - Buat grup kontak dengan valu string kosong', () => {
//     const navigateToKontak = () => {
//       cy.get('[data-testid="drawer-item-contacts"]').click();
//     };
...
// describe('[KONTAK-PELANGGAN] - Pengaturan Grup Kontak - Buat grup kontak dengan value yang benar', () => {
//     const navigateToKontak = () => {
//           cy.get('[data-testid="drawer-item-contacts"]').click();
//         //   cy.url().should('eq', 'https://cashflow.assist.id/admin/contacts');
//         };
...
// describe('[KONTAK-PELANGGAN] - Pengaturan Grup Kontak - Batal buat grup kontak', () => {
//     const navigateToKontak = () => {
//       cy.get('[data-testid="drawer-item-contacts"]').click();
//     //   cy.url().should('eq', 'https://cashflow.assist.id/admin/contacts');
//     };
...
// describe('[KONTAK-PELANGGAN] - Pengaturan Grup Kontak - Hapus grup kontak', () => {
//     const navigateToKontak = () => {
//             cy.get('[data-testid="drawer-item-contacts"]').click();
//             // cy.url().should('eq', 'https://cashflow.assist.id/admin/contacts');
//           };
...
// describe('[KONTAK-PELANGGAN] - Edit data grup dengan value yang berbeda', () => {
//     const navigateToKontak = () => {
//             cy.get('[data-testid="drawer-item-contacts"]').click();
//             // cy.url().should('eq', 'https://cashflow.assist.id/admin/contacts');
//           };
